...
白嫖的项目：签到白嫖游戏服务器或者稳定的虚拟主机，攒着提现也可以（2018年以来一直稳定运行的，自己可以查一查资料）
 ...
 第二步：去  https://www.rainyun.com/?ref=rain 注册一个账号（不提现只抢游戏云和主机的话不用实名）
 想提现的话6万积分起提现...绑定支付宝提现（稳到，亲测过，也有官方用户群）。
 第三步：本脚本里你的账号 你的密码里替换一下自己注册的账号和密码！！！
         本脚本里你的账号 你的密码里替换一下自己注册的账号和密码！！！
         本脚本里第121行122行里设置一下自己注册的账号和密码！！！
第四步：时间规则：0 0 23 * * ?    #每天 23 点执行一次 （可以按自己的需求，每天执行一次）
第五步：网页登录一下账号，过验证，F12或开发者模式，刷新一下，网络选项里找到浏览器UA数据复制，搜索代码中的"User-Agent":替换成自己的
